...
<html>
  <head>
    <title><s:text name="COMMON_TITLE"></s:text>-销售回访管理</title>
  ...
  <body>
    <table id="dg" class="easyui-datagrid"
            ...
            url:'${pageContext.request.contextPath}/main/queryMarketReturnDataGridByJson.do',method:'post',toolbar:'#dg-toolbar'">
        <thead>
            <tr>
    ...
    <div id="dg-toolbar" style="padding:5px;height:auto">
    	<div>
            <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" onclick="operation('add','${pageContext.request.contextPath}/main/doAddMarketReturn.do')"><s:text name="BUTTON.ADD"></s:text></a>
            <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'" onclick="operation('edit','${pageContext.request.contextPath}/main/doUpdateMarketReturn.do')"><s:text name="BUTTON.EDIT"></s:text></a>
            <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-cancel'" onclick="operation('del','${pageContext.request.contextPath}/main/doDeleteMarketReturn.do')"><s:text name="BUTTON.DEL"></s:text></a>
        </div>
        <div>
    ...
    <div id="dlg" class="easyui-dialog" style="padding:10px" 
	    ...
	    <form id="dlgFm" action="" method="post">
	    	<input id="dlg_id" type="hidden" name="marketReturn.id" value=""></input>
            <fieldset>
	    		<legend>回访填写</legend>
	            <table style="border: 1">
		                ...
		                <td align="left">
		                	<input id="dlg_title" type="text" maxlength="256" style="width:100px;" name="marketReturn.return_title">
		                </td>  
		                <td align="right">回访内容:</td>  
		                <td align="left">
		                	<input id="dlg_content" style="width:100px;" name="marketReturn.return_content" type="text">
		                </td>  
		            </tr>  
		            <tr>  
		                <td align="right">备注:</td>  
		                <td align="left" colspan="3">
		                	<textarea rows="5" cols="80" id="dlg_project_description" name="marketReturn.project_description"></textarea>
		                </td>  
		            </tr> 
	          	</table>
	       </fieldset>
  ...
  <script type="text/javascript">
	...
	function loadForm(row) {
		$.post(
			"${pageContext.request.contextPath}/main/queryMarketReturnByJson.do",
			{"form.id":row.id},
			function(data){
				if(data != null) {
					$("#dlg_id").val(data.id);
